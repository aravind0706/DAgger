...
"""
Usage: python bc_tf.py expert_data_s_a_Humanoid-v1.pkl Humanoid-v1 --obs_dim 376 --act_dim 17 --num_epochs 20 --num_updates 100 --num_expert_rollouts 120 --plot --render --table
       python bc_tf.py expert_data_s_a_Reacher-v1.pkl Reacher-v1 --obs_dim 11 --act_dim 2 --num_epochs 20 --num_updates 100 --num_expert_rollouts 25 --plot --render --table
       python bc_tf.py expert_data_s_a_Hopper-v1.pkl Hopper-v1 --obs_dim 11 --act_dim 3 --num_epochs 20 --num_updates 100 --num_expert_rollouts 25 --plot --render --table
"""
...
class Network(object):
    ...
    def _build_graph(self):
        h1 = tf.nn.tanh(tf.matmul(self.obs, self.W1) + self.b1)
...
def main():
    ...
    pickle.dump(returns, open('bc_returns_' + args.envname + '.pkl', 'wb'))
    ...
    if args.render:
        ...
        plt.title('Behavior Cloning Learning Curve ' + args.envname)
        plt.savefig('BC_Curve_'+ args.envname + '.png')
