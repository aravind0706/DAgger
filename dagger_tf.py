...
"""
Usage:
    python dagger_tf.py Humanoid-v1 expert_data_s_a_Humanoid-v1.pkl experts/Humanoid-v1.pkl --obs_dim 376 --act_dim 17 --num_dagger 20 --num_rollouts 20 --num_updates 100 --plot --render --table --num_expert_rollouts 120

    python dagger_tf.py Reacher-v1 expert_data_s_a_Reacher-v1.pkl experts/Reacher-v1.pkl --obs_dim 11 --act_dim 2 --num_dagger 20 --num_rollouts 20 --num_updates 100 --plot --render --table --num_expert_rollouts 25
...
def main():
    ...
    pickle.dump(returns, open('dagger_returns_' + args.envname + '.pkl', 'wb'))
    # Plot
    if args.plot:
        plt.figure()
        ...
        plt.title('DAgger Learning Curve ' + args.envname)
        plt.savefig('DAgger_Curve_'+ args.envname + '.png')
